...
cd TopBJets/TopAnalyzer/macros/slurm/run2017/SingleElectron/SBR
echo 'g++ `root-config --cflags --glibs` -lGenVector DataYield12.C ConstrainedFit.cc -o fit12 && ./fit12'
