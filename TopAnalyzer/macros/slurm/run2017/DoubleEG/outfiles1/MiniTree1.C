...
void MiniTree1() {
  ...
  while(!file.eof()) {
    ...
    if(fname.substr(fname.size() - 5,5) == ".root") {
      ...
      std::size_t epos = fname.find("run2017");
      std::string ext = fname.substr(epos,8);
      int pos = fname.find("_run2017");
      std::string ds = fname.substr(45,pos);
      cout<<outfile<<endl;
      cout<<ext<<endl;
      cout<<pos<<"  "<<ds<<endl;
      ...
      T1->SetBranchAddress("hlt_Mu17_Mu8_DZ_Mass8", &hlt_Mu17_Mu8_DZ_Mass8);
      T1->SetBranchAddress("hlt_IsoMu27", &hlt_IsoMu27);
      T1->SetBranchAddress("hlt_Ele23_Ele12_IsoVL", &hlt_Ele23_Ele12_IsoVL);
      T1->SetBranchAddress("hlt_Double_Ele33_MW", &hlt_Double_Ele33_MW);
      T1->SetBranchAddress("hlt_Ele35_WPTight", &hlt_Ele35_WPTight);
