...
void MiniTree1() {
  ...
  while(!file.eof()) {
    ...
    if(fname.substr(fname.size() - 5,5) == ".root") {
      ...
      double nJet;
      bool hlt_IsoMu24,
           hlt_Mu17_Mu8_DZ_Mass3p8;
      bool hlt_Ele23_Ele12_IsoVL,
           hlt_Ele32_WPTight,
           hlt_Double_Ele25_MW;
      bool hlt_Mu8_Ele23_DZ,
           hlt_Mu23_Ele12_IsoVL;
      ...
      T1->SetBranchAddress("hlt_Mu17_Mu8_DZ_Mass3p8", &hlt_Mu17_Mu8_DZ_Mass3p8);
      T1->SetBranchAddress("hlt_Ele23_Ele12_IsoVL", &hlt_Ele23_Ele12_IsoVL);
      T1->SetBranchAddress("hlt_Ele32_WPTight", &hlt_Ele32_WPTight);
      T1->SetBranchAddress("hlt_Double_Ele25_MW", &hlt_Double_Ele25_MW);
      T1->SetBranchAddress("hlt_Mu8_Ele23_DZ", &hlt_Mu8_Ele23_DZ);
      T1->SetBranchAddress("hlt_Mu23_Ele12_IsoVL", &hlt_Mu23_Ele12_IsoVL);
      ...
      for(unsigned int jentry=0; jentry<nentries; jentry++) {
        ...
        if(dilepton) if(!hlt_IsoMu24           && !hlt_Mu17_Mu8_DZ_Mass3p8 &&
                        !hlt_Ele23_Ele12_IsoVL && !hlt_Ele32_WPTight &&
                        !hlt_Double_Ele25_MW   && !hlt_Mu8_Ele23_DZ  && !hlt_Mu23_Ele12_IsoVL) continue;
        if(singlelepton) if(!hlt_IsoMu24 && !hlt_Ele32_WPTight) continue;
        tree->Fill();
        //cout<<endl;
      }
      f2->Write();
